  ...
  start: async (
    ...
    switch (inputCMD) {
      case "3dcristmas":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}3dchristmas Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "3dneon":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}3dneon Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "3dspace":
        if (!text.includes(",")) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}3dspace Wha-X Bot , Team WhaX*`);
        }
        await doReact("🏮");
        teks1 = text.split(",")[0];
        teks2 = text.split(",")[1];
      ...
      case "3dstone":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}3dstone Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "bear":
        if (!text.includes(",")) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}bear Wha-X Bot , Team WhaX*`);
        }
        await doReact("🏮");
        teks1 = text.split(",")[0];
        teks2 = text.split(",")[1];
      ...
      case "blackpink":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}blackpink Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "blood":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}blood Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "bokeh":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}bokeh Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
      ...
      case "candy":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}candy Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "carbon":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}carbon Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
      ...
      case "chocolate":
        if (!text) {
          doReact("❌");
          return m.reply(`Example: *${prefix}chocolate Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
      ...
      case "christmas":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}christmas Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "circuit":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}circuit Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "cloud":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}cloud Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "deepsea":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}deepsea Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "demon":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}demon Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "dropwater":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}dropwater Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
      ...
      case "glitch":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}glitch Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "glitch2":
        if (!text.includes(",")) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}glitch2 Wha-X Bot , Team WhaX*`);
        }
        await doReact("🏮");
        teks1 = text.split(",")[0];
        teks2 = text.split(",")[1];
      ...
      case "glitch3":
        if (!text.includes(",")) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}glitch3 Wha-X Bot , Team WhaX*`);
        }
        await doReact("🏮");
        teks1 = text.split(",")[0];
        teks2 = text.split(",")[1];
      ...
      case "graffiti":
        if (!text.includes(",")) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}graffiti Wha-X Bot,Team WhaX*`);
        }
        await doReact("🏮");
        teks1 = text.split(",")[0];
        teks2 = text.split(",")[1];
      ...
      case "hollographic":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}holographic Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
      ...
      case "joker":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}joker Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
      ...
      case "lion":
        if (!text.includes(",")) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}lion Wha-X Bot , Team WhaX*`);
        }
        await doReact("🏮");
        teks1 = text.split(",")[0];
        teks2 = text.split(",")[1];
      ...
      case "magma":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}magma Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "matrix":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}matrix Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "neon":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}neon Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
      ...
      case "neondevil":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}neondevil Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "neongreen":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}neonlight Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "papercut":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}papercut Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "pencil":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}pencil Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "pornhub":
        if (!text.includes(",")) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}pornhub Wha-X Bot,Team WhaX*`);
        }
        await doReact("🏮");
        teks1 = text.split(",")[0];
        teks2 = text.split(",")[1];
      ...
      case "scifi":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}scifi Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "sparklechristmas":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}schristmas Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "thunder":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}thunder Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "transformer":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}transformer Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "thunder2":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}thunder2 Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
          .textpro(
      ...
      case "wall":
        if (!text) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}wall Wha-X Bot*`);
        }
        await doReact("🏮");
        maker
      ...
      case "wolf":
        if (!text.includes(",")) {
          await doReact("❌");
          return m.reply(`Example: *${prefix}wolf Wha-X Bot , Team WhaX*`);
        }
        await doReact("🏮");
        teks1 = text.split(",")[0];
        teks2 = text.split(",")[1];
